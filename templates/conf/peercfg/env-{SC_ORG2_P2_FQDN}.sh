...
export SC_SG_PEER_NAME=${SC_ORG2_P2_NAME}
export SC_SG_PEER_FQDN=${SC_ORG2_P2_FQDN}
export SC_SG_PEER_PORT=${SC_ORG2_P2_PORT}
...
export CORE_PEER_ADDRESS=${SC_ORG2_P2_FQDN}:${SC_ORG2_P2_PORT}

...
export SC_SG_PEER_NAME=${SC_ORG1_P1_NAME}
export SC_SG_PEER_FQDN=${SC_ORG1_P1_FQDN}
export SC_SG_PEER_PORT=${SC_ORG1_P1_PORT}
...
export CORE_PEER_ADDRESS=${SC_ORG1_P1_FQDN}:${SC_ORG1_P1_PORT}
